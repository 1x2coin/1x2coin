...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop 1X2 Coin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "1X2 Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"1x2coin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"1x2coin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use 1x2coind, or the -server option to 1x2coin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
