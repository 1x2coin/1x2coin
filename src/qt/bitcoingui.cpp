                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("1X2 Coin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a 1X2 Coin address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About 1X2 Coin Core"), this);
    aboutAction->setStatusTip(tr("Show information about 1X2 Coin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for 1X2 Coin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your 1X2 Coin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified 1X2 Coin addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the 1X2 Coin Core help message to get a list with possible 1X2 Coin command-line options"));
...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
        ...
        label->setStyleSheet("QLabel { margin: 0 20px 0 10px; }");
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("1X2 Coin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to 1X2 Coin network", "", count));
}
...
{
    QString strTitle = tr("1X2 Coin Core"); // default title
