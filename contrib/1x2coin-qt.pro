...
RESOURCES += src/qt/1x2coin.qrc src/qt/1x2coin_locale.qrc

TRANSLATIONS += src/qt/locale/1x2coin_bg.ts \
                src/qt/locale/1x2coin_de.ts \
                src/qt/locale/1x2coin_en.ts \
                src/qt/locale/1x2coin_es.ts \
                src/qt/locale/1x2coin_fi.ts \
                src/qt/locale/1x2coin_fr.ts \
                src/qt/locale/1x2coin_it.ts \
                src/qt/locale/1x2coin_ja.ts \
                src/qt/locale/1x2coin_pl.ts \
                src/qt/locale/1x2coin_pt.ts \
                src/qt/locale/1x2coin_ru.ts \
                src/qt/locale/1x2coin_sk.ts \
                src/qt/locale/1x2coin_sv.ts \
                src/qt/locale/1x2coin_vi.ts \
                src/qt/locale/1x2coin_zh_CN.ts \
                src/qt/locale/1x2coin_zh_TW.ts
