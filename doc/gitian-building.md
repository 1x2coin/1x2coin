...
*Setup instructions for a gitian build of 1X2 Coin using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the 1X2 Coin
...
- [Building 1X2 Coin](#building-1X2coin)
...
To build 1X2 Coin (for Linux, OSX and Windows) just follow the steps under 'perform
...
For example:
```bash
URL=https://github.com/crowning-/1X2coin.git
