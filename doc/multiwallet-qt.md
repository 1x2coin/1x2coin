...
In order to support loading of multiple wallets in 1x2coin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is 1x2coin.cpp.
...
Changes to 1x2coin.cpp
----------------------
1x2coin.cpp is the entry point into 1x2coin-qt, and as such, will require some minor modifications to provide hooks for
