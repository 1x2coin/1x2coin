...
1X2 Coin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ 1X2 Coin, _12_ times over the course of a year totaling _24000_ 1X2 Coin.
...
When block `1000000` is reached you'll receive a payment for `1200` 1X2 Coin.
